...
<!-- Mirrored from bestwebcreator.com/shopwise/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Dec 2020 07:43:35 GMT -->
<head>
<!-- Meta -->
<meta charset="utf-8">
    	...
    	<div class="container">
            <nav class="navbar navbar-expand-lg"> 
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                            <li class="dropdown active"><a class="nav-link nav_item" href="/">Home</a></li>   
                            <li><a class="nav-link nav_item" href="{{ route('about') }}">About</a></li>   
                            <li><a class="nav-link nav_item" href="{{ route('product') }}">Product</a></li>   
                            <li><a class="nav-link nav_item" href="{{ route('blog') }}">Blog</a></li>   
                            <li><a class="nav-link nav_item" href="{{ route('shop') }}">Shop</a></li>   
...
<!-- Mirrored from bestwebcreator.com/shopwise/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Dec 2020 07:46:15 GMT -->
</html>